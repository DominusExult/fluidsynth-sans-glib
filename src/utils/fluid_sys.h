...
#define fluid_shell_parse_argv(command_line, argcp, argvp) _shell_parse_argv(command_line, argcp, argvp)
#define fluid_strfreev _strfreev
...
#endif
#if defined(_WIN32_) || HAVE_WINDOWS_H
